...
namespace A13{
    ...
    var product01: Product= {
        ...
        available:true,
        size: ["XS","S","M","L","XL","XXL","3XL"], //Augabe 10.3 -> Array mit verschiedenen Produktgr��en
        pack: [40,30,30],
    ...
    var shopProducts:Product[]=[product01,product02,product03,product04,product05,product06,product07,product08,product09,product10,product11,product12,product13,product14,product15,product16,product17,product18,product19,product20,product21,product22,product23,product24,product25,product26,product27];
    
    // Funktion zur Ausgabe im HTML-Code mit Hilfe einer Schleife
    export function generateProductOverview() : void {
      
        var node : any = document.getElementById("mainContent");
    ...
    */
    ...
    function filterByPrice (costs1 : number, costs2:number): void {
        let n:number=0;
        
        
        for(n=0;n<shopProducts.length;n++){
            var node : any = document.getElementById("filter0" + n);
    ...
    function filterByRegion(region:string):void{
        ...
        for(y=0;y<shopProducts.length;y++){
            var node1 : any = document.getElementById("filter0" + y);
    ...
    function filterByPosition(posi:string):void{
        let y:number=0;
        
        for(y=0;y<shopProducts.length;y++){
            let node : any = document.getElementById("filter0" + y);
    ...
    var columns:footer[]=[column1, column2, column3, column4];
    
    //funktion zur Erstellung des Footer
    export function generateFooter(): void{
        
        var node1 : any = document.getElementById("footerContent");
        
        //HTML-String
        var childNodeHTML1 : string;
